      ...
      <div className="space-y-4 sm:space-y-6">
        {faqs.map((faq, index) => (
          ...
          >
            ...
            >
              <span className="text-base md:text-xl font-semibold text-[#172128]">
                {faq.question}
              </span>
              <FaChevronDown
            ...
            <div
              className={`mt-2 text-gray-500 text-sm md:text-xl overflow-hidden transition-all duration-300 ${
